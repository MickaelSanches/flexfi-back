...
describe('LOI API Routes', () => {
  ...
  describe('POST /api/loi', () => {
    it('should create a new LOI', async () => {
      ...
      expect(response.body.message).toBe('Letter of Intent submitted successfully');
      expect(response.body.data.pdfUrl).toContain('/uploads/loi/LOI_FlexFi_Test_Company');
